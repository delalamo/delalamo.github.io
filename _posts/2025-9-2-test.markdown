...
![Kinked CDR3 loops are more difficult to predict than extended loops]({{ site.baseurl }}/_assets/2025_09_02_A.png)
*Figure from [4]*

Fortunately, these models were effective at predicting whether the kink was there or not. 

![CDR3 conformation is mostly correctly predicted by AlphaFold2 and AlphaFold3]({{ site.baseurl }}/_assets/2025_09_02_B.png)
*Figure from [4]*
